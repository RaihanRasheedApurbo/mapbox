...
public class MainActivity5 extends AppCompatActivity implements
    ...
    private static class MainActivityLocationCallback
        ...
        private final WeakReference<MainActivity5> activityWeakReference;

        MainActivityLocationCallback(MainActivity5 activity) {
        ...
        public void onSuccess(LocationEngineResult result) {
            MainActivity5 activity = activityWeakReference.get();
